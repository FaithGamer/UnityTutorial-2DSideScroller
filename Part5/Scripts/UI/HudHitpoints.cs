...
public class HudHitpoints : MonoBehaviour
{
    ...
    [SerializeField] PlayerFinder m_playerFinder;
    ...
    private void Start()
    {
        m_playerFinder.PlayerObjectChangedEvent += OnPlayerObjectChanged;
    }
    public void OnPlayerObjectChanged(PlayerObjectChangedEventData data)
    {
        var stats = data.instance.GetComponent<CharacterStats>();
        if (stats != null)
        {
